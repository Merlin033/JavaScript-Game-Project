...
export class Background {
	constructor(game) {
		...
		this.layer7 = new Layer(this.game, this.width, this.height, 0.2, this.layer7image);
		...
		this.backgroundLayers = [this.layer6, this.layer7, this.layer8, this.layer9, this.layer10];
	}
	update() {
